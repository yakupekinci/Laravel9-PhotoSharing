                    ...
                    <div class="d-flex justify-content-between flex-wrap">
                        <div class="d-flex align-items-end flex-wrap">
                            <div class="me-md-3 me-xl-5">
                                <a href="{{route('userphoto.create')}}" class="btn btn-info">Add Photo</a>
                            </div>
                            <div class="d-flex">
                                ...
                                <a class="text-muted mb-0 hover-cursor" href="{{route('userphoto.index')}}/">/Dashboard/</a></p>
                            ...
                            <div class="table-responsive pt-3">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{route('userphoto.index',['pid'=>$rs->id])}}"
                                        ...
                                        <td><a href="{{route('userphoto.show',['id'=>$rs->id])}}"class="btn btn-warning">Show</a>  </td>
                                    </tr>
