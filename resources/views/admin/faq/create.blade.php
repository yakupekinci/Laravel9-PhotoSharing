            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-inline" action="{{route('admin.faq.store')}}"  method="post" enctype="multipart/form-data">
                            @csrf

                            <label class= "sr-only" for="inlineFormInputName2">Question</label>
                            <input type="text" class="form-control mb-2 mr-sm-2" name="question" placeholder="Question">

                            <label class= "sr-only" for="inlineFormInputName2">Answer </label>
                            <textarea  class="form-control mb-2 mr-sm-2" id="answer" name="answer" ></textarea>
                            <script>
                                ClassicEditor
